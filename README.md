...
A simple, minimal, easy-to-use landing page starter without all sorts of bells and whistles bolted on. Create a super fast, beautiful landing page from a barebones template with a single page that already looks good.
